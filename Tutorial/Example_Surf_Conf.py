...
# Here I have declared both species to be adsorbed on the surface
# This will change my initial condition, which is in the spec_info
# As well as the isotherm constants
mechanism="E(1):a*=b*"
...
# Initial condition given as surface conentration
spec_info=[
    [10**-5,0], #[mol/m^2]
    [] #[mol/m^3]
    ]
...
# Here I declare the constants for both species as 0, to ensure langmuir behaviour
isotherm=[0,0] # /
...
# Run the simulation
E,i,t=simulator_Main_loop(mechanism, [kin_const, cell_c, D, isotherm], si, t, spec_info, E) #V, A, s
