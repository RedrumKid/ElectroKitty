...
# To denote arrows use = or -, for a reversible or irreversible reaction.

#In this example we combine two electochemical steps, with a chemical step
# We separate the individual step with \n. 
mechanism="E(1):a=b \n C:b=c \n E(1):c=d"
...
spec_info=[
    [], #[mol/m^2]
    [uniform(c0),uniform(0),uniform(0),uniform(0)] #[mol/m^3]
    ]
